...
const COPY = {
  ...
  en: {
    ...
    r3: "<b>Dress code:</b> chill (but photo-friendly).",
...
function showToast(t) {
  ...
  window.__t = setTimeout(() => (toastMsg.value = ""), 2600);
}
  ...
  const msgs =
    lang.value === "es"
      ? [
          ...
          "Evaluando objeción…",
          "Resultado: DENEGADO.",
          "Motivo: demasiado amor. Igual venís.",
        ]
      : [
          "Request received…",
          "Reviewing objection…",
          "Decision: DENIED.",
          "Reason: too much love. You're still coming.",
        ];
  let i = 0;
